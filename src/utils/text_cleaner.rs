...
const NEGATIONS: &[&str] = &[
    "not", "no", "nor", "never", "neither", "nobody", "nothing", "nowhere", "none", "cannot",
    "can't", "don't", "doesn't", "didn't", "won't", "wouldn't", "shouldn't", "couldn't",
...
const STOPWORDS: &[&str] = &[
    ...
    "could", "am", "i", "me", "my", "myself", "we", "our", "ours", "ourselves", "you", "your",
    "yours", "yourself", "yourselves", "he", "him", "his", "himself", "she", "her", "hers",
    "herself", "it", "its", "itself", "they", "them", "their", "theirs", "themselves", "what",
    "which", "who", "whom", "this", "that", "these", "those", "of", "in", "for", "on", "with",
    "at", "by", "from", "to", "into", "through", "during", "before", "after", "above", "below",
    "between", "and", "but", "or", "so", "if", "then", "because", "as", "until", "while", "about",
    "against", "each", "few", "more", "most", "other", "some", "such", "only", "own", "same",
    "than", "too", "very", "just", "also", "both", "how", "when", "where", "why", "all", "any",
    "here", "there", "up", "out", "over", "under", "again", "further", "once",
];
